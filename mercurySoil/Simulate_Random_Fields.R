  ...
  swissRain_samples_iso <- readRDS( "To_Explore/Models/Isotropic_Simulation_Fit.RDS" )
  ...
  # swissMap = mapmisc::tonerToTrans(mapmisc::openmap(swissRain, path = 'stamen-toner'))
  ...
  Us_iso_conditional <- foreach ( ii = sample_idx, .combine = cbind ) %dopar% {
    ...
    iso_stan_2 = c( range = 1000 * swissRain_stanfit_iso$phi_2[ii],
                    ...
                    anisoRatio = swissRain_Stan_data_iso_plot$Ratio[ii]+1 )
    ...
    if (ii %in% c(754,2468,2915) ) {
      ...
      png( filename = paste0("Figures/Random_Fields/swissRain_Iso_Posterior_Sample_",ii,".png"),
  ...
  png( filename = paste0("Figures/Random_Fields/swissRain_Iso_Posterior_Mean.png"),
       res = 300, width = 1.5 * 1928, height = 1.5 * 1514, unit = "px" )
  ...
  swissRain_samples_aniso <- readRDS( "To_Explore/Models/Anisotropic_Simulation_Fit.RDS" ) 
  ...
  Us_aniso_conditional <- foreach ( ii = sample_idx, .combine = cbind ) %dopar% {
    ...
    aniso_stan_2 = c( range = 1000 * swissRain_stanfit_aniso$phi_2[ii],
                      ...
                      anisoRatio = swissRain_Stan_data_aniso_plot$Ratio[ii]+1 )
    ...
    if (ii %in% c(1598,1784,1968) ) {
      ...
      png( filename = paste0("Figures/Random_Fields/swissRain_Aniso_Posterior_Sample_",ii,".png"),
           res = 300, width = 1.5 * 1928, height = 1.5 * 1514, unit = "px" )
  ...
  png( filename = paste0("Figures/Random_Fields/swissRain_Aniso_Posterior_Mean.png"),
       res = 300, width = 1.5 * 1928, height = 1.5 * 1514, unit = "px" )
  ...
  swissRain_samples <- readRDS( "To_Explore/Models/Switzerland_Rainfall_Fit.RDS" )
  ...
  Us_real_conditional <- foreach ( ii = sample_idx, .combine = cbind ) %dopar% {
    ...
    real_stan_2 = c( range = 1000 * swissRain_stanfit$phi_2[ii],
                     ...
                     anisoRatio = swissRain_Stan_data_real_plot$Ratio[ii]+1 )
    ...
    if ( ii %in% c(3774,3826,3903) ) {
      ...
      png( filename = paste0("Figures/Random_Fields/swissRain_Posterior_Sample_",ii,".png"),
           res = 300, width = 1.5 * 1928, height = 1.5 * 1514, unit = "px" )
  ...
  png( filename = paste0("Figures/Random_Fields/swissRain_Posterior_Mean.png"),
       res = 300, width = 1.5 * 1928, height = 1.5 * 1514, unit = "px" )
